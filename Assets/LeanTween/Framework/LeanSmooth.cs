...
public class LeanSmooth {
    ...
    * @param {float} maxSpeed:float the top speedLevel you want the value to move at (defaults to unlimited -1f)
    ...
    */
    ...
    /**
    * <summary>Moves one value towards another (at a constant speedLevel)</summary>
    * 
    * @method LeanSmooth.linear (float)
    * @param {float} current:float the current value
    * @param {float} target:float the value we are trying to reach
    * @param {float} moveSpeed:float the speedLevel at which to move towards the target
    * @param {float} deltaTime:float the difference in time since the method was called (defaults to Time.deltaTime)
    * @example
    ...
    */
    ...
    /**
    * <summary>Moves one color towards another (at a constant speedLevel)</summary>
    * 
